...
(function ($) {
    ...
    * */
    $.fn.editable = function (option) {
        ...
        let result = {}, args = arguments, datakey = 'editable';
        switch (option) {
            /**
            ...
            * */
            case 'validate':
                this.each(function () {
                    let $this = $(this), data = $this.data(datakey), error;
    ...
    $.extend(List.prototype, {
        ...
        value2html (value, element, display, response) {
            ...
            if(value === null) {
               ...
               this.onSourceReady(success, () => { deferred.resolve(); });
            }
        ...
        */
        makeArray(data) {
            let count, obj, result = [], item, iterateItem;
...
(function ($) {
    ...
    Combodate.prototype = {
        ...
        */
        fillDay() {
            let items = this.fillCommon('d'), name, i,
        ...
        */
        fillMonth() {
            let items = this.fillCommon('M'), name, i, 
        ...
        */
        fillHour() {
            let items = this.fillCommon('h'), name, i,
        ...
        */
        fillSecond() {
            let items = this.fillCommon('s'), name, i,
...
(function ($) {
    ...
    $.extend($.fn.editableform.Constructor.prototype, {
         ...
         initInput() {  
            ...
            const defaultClass = 'input-medium';
            
            // add bs2 default class to standard inputs
            // if(this.input.$input.is('input,select,textarea')) {
            const stdtypes = 'text,select,textarea,password,email,url,tel,number,range,time'.split(','); 
	...
	var DPGlobal = {
		...
		parseDate(date, format, language) {
			...
			var parts = date && date.match(this.nonpunctuation) || [],
				...
				setters_map = {
					yyyy(d,v){ return d.setUTCFullYear(v); },
					yy(d,v){ return d.setUTCFullYear(2000+v); },
					m(d,v){
						v -= 1;
						while (v<0) v += 12;
						v %= 12;
...
(function ($) {
    ...
    $.extend(Constructor.prototype, {
        renderList() {
            ...
            const ta = this.$input.data('typeahead');
        ...
        input2value() {
            if(this.getIsObjects()) {
                let value = this.$input.data('value'),
                    items = $.fn.editableutils.itemsByValue(value, this.sourceData);
...
//                i = $(that.options.item).attr('data-value', item)
        ...
        // see https://github.com/twitter/bootstrap/pull/4164         
        typeaheadSelect () {
          const val = this.$menu.find('.active').data('item')

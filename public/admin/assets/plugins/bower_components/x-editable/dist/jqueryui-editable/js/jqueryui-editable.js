...
(function ($) {
    ...
    $.extend($.fn.editableContainer.Popup.prototype, {
            ...
            $.extend(this.containerOptions, {
                ...
                open: $.proxy(function() {
                        ...
                        this.container()._on(this.container().element, {
                            mouseleave(e){ e.stopImmediatePropagation(); },
                            focusout(e){ e.stopImmediatePropagation(); }
                        });  
                    }, this)
            });
        ...
        innerShow() {
            this.call('open');
            const label = this.options.title || this.$element.data( "ui-tooltip-title") || this.$element.data( "originalTitle"); 

...
describe('jquery-typeahead.js', function() {
  let driver, body, input, hint, dropdown, allPassed = true;

  this.timeout(300000);

  before((done) => {
    let host = 'ondemand.saucelabs.com', port = 80, username, password;
  ...
  describe('on query change', () => {
    it('should open dropdown if suggestions', (done) => {
      driver.run(function*() {
        yield input.click();
        yield input.type('mi');
    ...
    it('should close dropdown if no suggestions', (done) => {
      driver.run(function*() {
        yield input.click();
    ...
    it('should render suggestions if suggestions', (done) => {
      driver.run(function*() {
        let suggestions;
    ...
    it('should show hint if top suggestion is a match', (done) => {
      driver.run(function*() {
        yield input.click();
        yield input.type('mi');
    ...
    it('should match hint to query', (done) => {
      driver.run(function*() {
        yield input.click();
    ...
    it('should not show hint if top suggestion is not a match', (done) => {
      driver.run(function*() {
        yield input.click();
    ...
    it('should not show hint if there is query overflow', (done) => {
      driver.run(function*() {
        yield input.click();
  ...
  describe('on up arrow', () => {
    it('should cycle through suggestions', (done) => {
      driver.run(function*() {
        let suggestions;
  ...
  describe('on tab', () => {
    it('should autocomplete if hint is present', (done) => {
      driver.run(function*() {
        yield input.click();
        yield input.type('mi');
    ...
    it('should select if cursor is on suggestion', (done) => {
      driver.run(function*() {
        let suggestions;
  ...
  describe('on suggestion click', () => {
    it('should select suggestion', (done) => {
      driver.run(function*() {
        let suggestions;

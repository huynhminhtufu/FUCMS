describe('Input', () => {
  ...
  describe('when the blur DOM event is triggered', () => {
  ...
  describe('when the focus DOM event is triggered', () => {
  ...
  describe('when the keydown DOM event is triggered by tab', () => {
  ...
  describe('when the keydown DOM event is triggered by esc', () => {
  ...
  describe('when the keydown DOM event is triggered by left', () => {
  ...
  describe('when the keydown DOM event is triggered by enter', () => {
  ...
  describe('when the keydown DOM event is triggered by up', () => {
    ...
    it('should prevent default if no modifers were pressed', function() {
      const $e = simulateKeyEvent(this.$input, 'keydown', KEYS.up);

      expect($e.preventDefault).toHaveBeenCalled();
    });

    it('should not prevent default if modifers were pressed', function() {
      const $e = simulateKeyEvent(this.$input, 'keydown', KEYS.up, true);

      expect($e.preventDefault).not.toHaveBeenCalled();
    });
  });

  describe('when the keydown DOM event is triggered by down', () => {
    ...
    it('should prevent default if no modifers were pressed', function() {
      const $e = simulateKeyEvent(this.$input, 'keydown', KEYS.down);

      expect($e.preventDefault).toHaveBeenCalled();
    });

    it('should not prevent default if modifers were pressed', function() {
      const $e = simulateKeyEvent(this.$input, 'keydown', KEYS.down, true);
  ...
  // in a async manner
  describe('when the input DOM event is triggered', () => {
  ...
  describe('.normalizeQuery', () => {
    ...
    it('should play nice with non-string values', () => {
  ...
  describe('#hasQueryChangedSinceLastFocus', () => {
  ...
  describe('#hasOverflow', () => {
    it('should return true if the input has overflow text', function() {
      const longStr = new Array(1000).join('a');

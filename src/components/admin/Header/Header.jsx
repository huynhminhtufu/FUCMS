      ...
      <header className="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar">
        ...
        <div className="navbar-nav-scroll">
          <ul className="navbar-nav bd-navbar-nav flex-row">
            ...
            <li className="nav-item">
              <a className="nav-link active" href="/docs/4.1/getting-started/introduction/" >Documentation</a>
            </li>
            <li className="nav-item">
              <a className="nav-link " href="/docs/4.1/examples/">Examples</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="https://themes.getbootstrap.com" target="_blank" rel="noopener">Themes</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="https://jobs.getbootstrap.com" target="_blank" rel="noopener">Jobs</a>
            </li>
            <li className="nav-item">
        ...
        <a className="btn btn-bd-download d-none d-lg-inline-block mb-3 mb-md-0 ml-md-3" href="https://github.com/twbs/bootstrap/archive/v4.1.1.zip">Download</a>
      </header>
    );
  }
}

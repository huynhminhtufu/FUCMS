    ...
    return (
      <div className="btn-group animated zoomInDown animation-delay-8">
          <button type="button" className="btn btn btn-primary dropdown-toggle color-white" data-toggle="dropdown" data-hover="dropdown" aria-haspopup="true" aria-expanded="false">
              {profile.displayName} <i className="zmdi zmdi-chevron-down right" />
          </button>
          <ul className="dropdown-menu">
              <li className="dropdown-header">{profile.displayName}</li>
              <li><Link className="dropdown-item" href="/me"><i className="zmdi zmdi-account-circle" />My profile</Link></li>
              <li><Link className="dropdown-item" href="/my-courses"><i className="zmdi zmdi-bookmark" />Courses</Link></li>
              <li><a className="dropdown-item" href="javascript:void(0)"><i className="zmdi zmdi-star" />Something else here</a></li>
              <li role="separator" className="dropdown-divider" />
              <li><a className="dropdown-item" href="/logout"><i className="zmdi zmdi-arrow-right" />Logout</a></li>
          </ul>
      </div>
    );
  }
